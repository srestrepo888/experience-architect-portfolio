          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center" style={{ gap: "16px" }}>
              ...
              >
                <a 
                  href="/#projects" 
                  className="inline-flex items-center bg-white/95 backdrop-blur-2xl text-primary hover:bg-white shadow-2xl border border-white/40 px-6 py-4 relative rounded-xl transition-all duration-200 before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-r before:from-white/10 before:to-transparent before:pointer-events-none"
                >
                  ← Back to Projects
                </a>
              </motion.div>
              ...
              >
                <a 
                  href="/" 
                  className="inline-flex items-center bg-white/90 backdrop-blur-2xl border border-white/60 text-primary hover:bg-white/95 shadow-xl px-6 py-4 rounded-xl relative before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-white/5 before:to-transparent before:pointer-events-none transition-all duration-200"
                >
                  Home
                </a>
              </motion.div>
            ...
            {project.webpage && (
              ...
              >
                <a
                  ...
                  className="inline-flex items-center bg-gradient-to-r from-primary to-primary/90 text-white shadow-2xl px-6 py-4 rounded-xl transition-all duration-200"
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr_auto] gap-8 items-center">
                  ...
                  >
                    <a 
                        ...
                        className="inline-flex items-center bg-primary hover:bg-primary/90 text-white shadow-xl px-8 py-4 text-lg font-medium rounded-xl transition-all duration-200"
                      >
                        Explore Next
                      </a>
                    </motion.div>
                  ...
                  <div className="flex items-center gap-3 lg:justify-end justify-center">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <a
                        href="/#projects"
                        className="inline-flex items-center bg-white/40 border border-primary/30 text-primary hover:bg-white/60 px-6 py-3 rounded-xl transition-all duration-200"
                      >
                        All Projects
                    </a>
                  </motion.div>
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <a
                        href="/#contact"
                        className="inline-flex items-center bg-primary/10 border border-primary/40 text-primary hover:bg-primary/20 px-6 py-3 rounded-xl transition-all duration-200"
                      >
                        Contact
                      </a>
                    </motion.div>
