    ...
    switch (section) {
      case "hero":
        ...
        return {
          ...
          overlayOpacity: [0.25, 0.15, 0.25],
          overlayColor: "from-slate-900/12 via-transparent to-slate-900/18",
      ...
      case "about":
        ...
        return {
          ...
          overlayColor: "from-rose-50/70 via-amber-50/60 to-orange-50/65",
